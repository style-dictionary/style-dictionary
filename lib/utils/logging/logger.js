...
export class Logger {
  ...
  get logMap() {
    return new Map([
      ['throw.references', this.throw.references],
      ['error.transforms', this.error.transforms],
      ['warn.collisions', this.warn.collisions],
      ['warn.nameCollisions', this.warn.nameCollisions],
    ]);
  }
